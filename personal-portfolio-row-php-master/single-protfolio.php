<?php 
	...
	$slug = $_GET['slug'];
    $portfolios_select = "SELECT * FROM portfolios WHERE slug = '$slug'";
    $portfolios_sq = mysqli_query($db, $portfolios_select);
    $portfolios_assoc = mysqli_fetch_assoc($portfolios_sq);
        ...
        <header>
            ...
            <div class="extra-info">
                ...
                <div class="side-info mb-30">
                    ...
                    <div class="contact-list mb-30">
                        <h4>Phone Number</h4>
                        <p><?= $contact_assco["phone"] ?></p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Email Address</h4>
                        <p><?= $contact_assco["email"] ?></p>
                    </div>
                </div>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="backend/upload/portfolio-img/feature/<?php echo $portfolios_assoc["feature_image"] ?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?= $portfolios_assoc["title"] ?></h2>
                                    <p>
                                        <?= $portfolios_assoc["description"] ?>
                                    </p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img src="backend/upload/<?php echo $users_assco["photo"]?>" alt="img">
                                            </div>
                                            <div class="post-avatar-content">
                                                <h5><?= $users_assco["name"] ?></h5>
                                                <p>
