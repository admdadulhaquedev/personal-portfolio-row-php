<?php 
    ...
    $service_select = "SELECT * FROM services WHERE status = 2";
...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12">
					<h3 class="page-title">Delete Services</h3>
					<ul class="breadcrumb">
										...
										<div class="course-content">
											...
											<div class="row">
												...
												<div class="col text-right">
													<a href="../undo-action/service-undo-action.php?id=<?php echo $service["id"] ?>" class="text-success">
														<i class="fa fa-redo-alt"></i> Active
													</a>
												</div>
											</div>
										</div>
