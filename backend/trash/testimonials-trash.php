...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12">
					<h3 class="page-title">Deleted Testimonials</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="../deshbord/deshbord.php">Dashboard</a>
						</li>
						<li class="breadcrumb-item active">Deleted Testimonials</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="card">
					...
					<form action="../delete-forever/multipul-messages-delete.php" method="POST">
						...
						<div class="card-header d-flex">
							<h4 class="card-title">Deleted Testimonials List's</h4>
								...
								<table class="table table-nowrap mb-0">
									...
									<tbody>
										...
										<tr class="<?php if($message["seen_status"] == "1"){echo "unseen";} ?>">
											...
											<td data-id="<?php echo $message["id"] ?>" class="clickable">
												<img class="profile_img comment" src="img" alt="Profile image">
											</td>
											<td data-id="<?php echo $message["id"] ?>" class="clickable">
												<?php echo $message["name"] ?>
											</td>
											<td data-id="<?php echo $message["id"] ?>" class="clickable message_text">
